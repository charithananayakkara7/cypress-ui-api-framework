pipeline {
  ...
  stages {
   ...
   post {
        always { 
            publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: true, htmlDir: 'cypress/report', reportFiles: 'index.html', reportName: 'HTML Report', reportTitles: ''])
        }
    }
